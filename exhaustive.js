(function () {
  ...
  const PATHS = {
    ...
    hotosmMap: "./data/hotosm_vehicular_map.geojson?v=20260821-20",
    hotosmAnalysis: "./data/hotosm_vehicular_analysis.json?v=20260821-20"
  };
