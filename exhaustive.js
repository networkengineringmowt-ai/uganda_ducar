...
(function () {
  ...
  const SECTION_META = {
    ...
    pims: ["link_id", "road_name", "District", "county", "subcounty", "parish", "surface", "pavement_class", "condition", "priority_band", "recommended_intervention", "planning_cost_ugx", "governance_department"],
  ...
  const SECTION_SQL = {
    ...
    pims: ["link_id", "road_name", "District", "county", "subcounty", "parish", "surface", "pavement_class", "condition", "priority_band", "recommended_intervention", "planning_cost_ugx", "governance_department"], hdm4: ["ducar_link_register", "pms_pavement_condition"],
  ...
  function lengthDashboard(rows) {
    ...
    const common = {
      ...
      pims: ["link_id", "road_name", "District", "county", "subcounty", "parish", "surface", "pavement_class", "condition", "priority_band", "recommended_intervention", "planning_cost_ugx", "governance_department"]],["Intervention pipeline","Cumulative treatment length.","recommended_intervention",COLORS[2]],["Screening by condition","Input length by condition.","condition",COLORS[0]],["Screening by pavement","Input length by pavement.","pavement_class",COLORS[1]]],
  ...
  function sectionFormulas(section) {
    ...
    const owned={
      ...
      budgets: ["link_id", "road_name", "District", "county", "subcounty", "surface", "pavement_class", "condition", "recommended_intervention", "planning_cost_ugx", "planning_cost_per_km_ugx", "governance_department"],"Urgent investment length.",true),coverageFormula("Planning allowance coverage","Planning Cost (UGX)","Length with planning allowance."),weightedFormula("Length-weighted unit allowance","planning_unit_cost_ugx_km","UGX/km","Unit allowance weighted by length."),weightedFormula("Length-weighted priority","planning_priority_score","points","Priority weighted by length.")],
...
function analyticsHtml() {
    ...
    const pairs={traffic:[["pavement_class","condition"],["priority_band","recommended_intervention"]],condition:[["condition","pavement_class"],["condition","recommended_intervention"]],network:[["surface","pavement_class"],["condition","surface"]],pims: ["link_id", "road_name", "District", "county", "subcounty", "parish", "surface", "pavement_class", "condition", "priority_band", "recommended_intervention", "planning_cost_ugx", "governance_department"],["priority_band","condition"]],hdm4:[["pavement_class","condition"],["priority_band","recommended_intervention"]],framework:[["admin_coverage","condition"],["pavement_class","priority_band"]],budgets: ["link_id", "road_name", "District", "county", "subcounty", "surface", "pavement_class", "condition", "recommended_intervention", "planning_cost_ugx", "planning_cost_per_km_ugx", "governance_department"],["condition","pavement_class"]],socioeconomic:[["exposure_band","primary_socioeconomic_factor"],["exposure_band","pavement_class"]],summaries:[["relation_basis","pavement_class"],["condition","priority_band"]],overview:[["condition","pavement_class"],["priority_band","recommended_intervention"]],ducar:[["condition","pavement_class"],["surface","recommended_intervention"]]};
